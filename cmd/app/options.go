...
func (o *Options) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&o.CleanupAndExit, "cleanup", o.CleanupAndExit, "If true cleanup rules and exit.")
	...
	fs.Var(&o.config.Mode, "proxy-mode", "Which proxy mode to use: on Windows the only supported value is 'kernelspace'."+
		"This parameter is ignored if a config file is specified by --config.")
